...
public class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(final byte[] data, final int offset, final int len,
                                         final int seed) {
    ...
    public static int murmurhash(String s) {
        byte[] k = s.getBytes();
        return murmurhash3_x86_32(k, 0, k.length, MURMURHASH_M);
    }
